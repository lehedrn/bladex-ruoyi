...
public class ApiEncryptResponseBodyAdvice implements ResponseBodyAdvice<Object> {
	...
	public ApiEncryptResponseBodyAdvice(ApiCryptoProperties apiCryptoProperties, BladeJacksonProperties bladeJacksonProperties) {
		this.apiCryptoProperties = apiCryptoProperties;
		this.objectMapper = JsonUtil.getInstance(bladeJacksonProperties);
	}
	...
	public Object beforeBodyWrite(Object body, @NonNull MethodParameter returnType, @NonNull MediaType selectedContentType,
		...
		if (cryptoInfoBean != null) {
			byte[] bodyJsonBytes = objectMapper.writeValueAsBytes(body);
			return ApiCryptoUtil.encryptData(apiCryptoProperties, bodyJsonBytes, cryptoInfoBean);
		}
