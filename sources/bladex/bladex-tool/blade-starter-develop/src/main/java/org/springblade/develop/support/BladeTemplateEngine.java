...
public class BladeTemplateEngine extends BeetlTemplateEngine {
	 ...
	 * 默认父级菜单ID(工作台菜单)
	 */
	private static final String PARENT_MENU_ID = "1123598815738675201";
	...
	protected void outputCustomFile(List<CustomFile> customFiles, TableInfo tableInfo, Map<String, Object> objectMap) {
		...
		String menuId = String.valueOf(objectMap.get("menuId"));
		Boolean hasMenuSql = Func.toBoolean(objectMap.get("hasMenuSql"));
		...
		customFiles.forEach(customFile -> {
			...
			if (StringUtil.equals(key, "menu.sql") && hasMenuSql) {
				objectMap.put("parentMenuId", StringUtil.isBlank(menuId) ? PARENT_MENU_ID : menuId);
