...
public class MybatisPlusConfiguration implements WebMvcConfigurer {
	...
	public PaginationInnerInterceptor paginationInnerInterceptor(ObjectProvider<QueryInterceptor[]> queryInterceptors,
	...
	public MybatisPlusInterceptor mybatisPlusInterceptor(PaginationInnerInterceptor paginationInterceptor,
		...
		// 配置数据变更拦截器
		if (mybatisPlusProperties.getRecordMode()) {
			dataChangeRecorderInnerInterceptor.setBatchUpdateLimit(mybatisPlusProperties.getBatchUpdateLimit());
