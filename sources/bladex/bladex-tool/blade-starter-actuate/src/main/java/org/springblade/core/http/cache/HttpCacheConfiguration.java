...
public class HttpCacheConfiguration implements WebMvcConfigurer {
	...
	@Bean
	public HttpCacheService httpCacheService(CacheManager cacheManager) {
	...
	public void addInterceptors(@NonNull InterceptorRegistry registry) {
		...
		HttpCacheService cacheService = context.getBean(HttpCacheService.class);
		HttpCacheInterceptor httpCacheInterceptor = new HttpCacheInterceptor(cacheService);
