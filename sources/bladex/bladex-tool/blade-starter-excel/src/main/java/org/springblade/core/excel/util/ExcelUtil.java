 ...
 *
 * @author Chill
 * @apiNote https://readmex.com/fast-excel/fastexcel
 */
public class ExcelUtil {
	...
	public static <T> void save(MultipartFile excel, ExcelImporter<T> importer, Class<T> clazz) {
		save(excel, importer, clazz, false);
	}
	 ...
	 * @param <T>      泛型
	 */
	public static <T> void saveWithCheck(MultipartFile excel, ExcelImporter<T> importer, Class<T> clazz) {
		save(excel, importer, clazz, true);
	}
	 ...
	 * @param <T>      泛型
	 */
	public static <T> void saveWithoutCheck(MultipartFile excel, ExcelImporter<T> importer, Class<T> clazz) {
		save(excel, importer, clazz, false);
	}
	 ...
	 * @param check    是否校验
	 */
	public static <T> void save(MultipartFile excel, ExcelImporter<T> importer, Class<T> clazz, Boolean check) {
		ImportListener<T> importListener = new ImportListener<>(importer, clazz, check);
