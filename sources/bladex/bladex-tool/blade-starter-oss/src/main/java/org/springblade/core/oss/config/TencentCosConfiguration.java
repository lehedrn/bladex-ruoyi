...
public class TencentCosConfiguration {
	...
	public COSClient ossClient(OssProperties ossProperties) {
	...
	public TencentCosTemplate tencentCosTemplate(COSClient cosClient, OssProperties ossProperties, OssRule ossRule) {
