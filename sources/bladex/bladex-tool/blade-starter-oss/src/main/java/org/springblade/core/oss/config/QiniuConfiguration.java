...
public class QiniuConfiguration {
	...
	public com.qiniu.storage.Configuration qnConfiguration(OssProperties ossProperties) {
	...
	@Bean
	@ConditionalOnBean(com.qiniu.storage.Configuration.class)
	public BucketManager bucketManager(com.qiniu.storage.Configuration cfg, OssProperties ossProperties) {
	...
	public QiniuTemplate qiniuTemplate(Auth auth, UploadManager uploadManager, BucketManager bucketManager, OssProperties ossProperties, OssRule ossRule) {
