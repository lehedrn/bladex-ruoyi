...
public class HuaweiObsConfiguration {
	...
	public OssRule ossRule(OssProperties ossProperties) {
		return new BladeOssRule(ossProperties.getTenantMode());
	}

	@Bean
	@ConditionalOnMissingBean(ObsClient.class)
	public ObsClient ossClient(OssProperties ossProperties) {
	...
	public HuaweiObsTemplate huaweiobsTemplate(ObsClient obsClient, OssProperties ossProperties, OssRule ossRule) {
